  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300
        ${scrolled ? 'bg-white/98 backdrop-blur-md shadow-md' : 'bg-white/90 backdrop-blur-sm'}`}
    >
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-[72px] flex items-center justify-between">
        ...
        <div className="flex-1 flex justify-end items-center gap-2">
          <Link to="/portal-creditos" className="hidden md:inline-flex btn-primary items-center gap-2 text-sm">
            Portal de Créditos
          </Link>
          <button
